...
T2W.FR_FR.DICTIONARY = {
	...
	tens		:[ "", "", "vingt", "trente", "quarante", "cinquante", "soixante", "soixante-dix", "quatrevingt", "quatre-vingt-dix" ],
	hundred		:"cent",
	radix		:["", "mille", "million"],
	delimiters	:["-", "et"]
};
...
T2W.FR_FR.prototype._getTrio = function( numbers, index, max){																				
	...
	if(numbers[T2W.HUNDRED_INDEX]){
		hundred = numbers[T2W.TEN_INDEX] || numbers[T2W.SINGLE_INDEX] 
			? this._getOnes( numbers[ T2W.HUNDRED_INDEX ] ) + " " + T2W.FR_FR.DICTIONARY.hundred + ' ' + T2W.FR_FR.DICTIONARY.delimiters[1] + ' '
	...
	if( index === 0 && index+1 < max && !numbers[ T2W.HUNDRED_INDEX ] && (numbers[T2W.TEN_INDEX] || numbers[T2W.SINGLE_INDEX] )){
		hundred	 = ' ' + T2W.FR_FR.DICTIONARY.delimiters[1] + ' ';		
	}
